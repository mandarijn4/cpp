...
int main() {
    ...
    for (auto columnIndex = 0; columnIndex < sizeOfBoard; columnIndex++)
    {
        for (auto rowIndex = 0; rowIndex < sizeOfBoard; rowIndex++)
        {
            ...
            {
                playBoard[columnIndex][rowIndex] += 64;
            }
        }
    }
    ...
    for (auto columnIndex = 0; columnIndex < sizeOfBoard; columnIndex++)
    {
        for (auto rowIndex = 0; rowIndex < sizeOfBoard; rowIndex++)
        {
            ...
            else if (playBoard[columnIndex][rowIndex] == 32){st::cout << '.' << ' ';}
            else if (playBoard[columnIndex][rowIndex] == 64){st::cout << ';' << ' ';}
            else if (playBoard[columnIndex][rowIndex] == 96){st::cout << '=' << ' ';}
            else {st::cout << '@' << ' ';}
        }
        st::cout << '\n';
    }
